...
public class TruckCompanyAdapter extends BaseAdapter {
    private Context mContext;
    ArrayList<VehicleServices> mylist=new ArrayList<>();
    public TruckCompanyAdapter(ArrayList<VehicleServices> itemArray, Context mContext) {
        super();
    ...
    public View getView(final int position, View convertView,
        ...
        TruckCompanyAdapter.ViewHolder view = null;
        LayoutInflater inflator = ((Activity) mContext).getLayoutInflater();
        if (view == null) {
            view = new TruckCompanyAdapter.ViewHolder();
            ...
            view = (TruckCompanyAdapter.ViewHolder) convertView.getTag();
        }
