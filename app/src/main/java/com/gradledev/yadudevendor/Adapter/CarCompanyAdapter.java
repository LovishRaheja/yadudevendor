...
public class CarCompanyAdapter extends BaseAdapter {
    ...
    public CarCompanyAdapter(ArrayList<VehicleServices> itemArray, Context mContext) {
        super();
    ...
    public View getView(final int position, View convertView,
        ...
        CarCompanyAdapter.ViewHolder view = null;
        LayoutInflater inflator = ((Activity) mContext).getLayoutInflater();
        if (view == null) {
            view = new CarCompanyAdapter.ViewHolder();
            ...
            view = (CarCompanyAdapter.ViewHolder) convertView.getTag();
        }
