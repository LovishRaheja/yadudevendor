...
public class AutoRickshawCompaniesAdapter extends BaseAdapter {
    private Context mContext;
    ArrayList<VehicleServices> mylist=new ArrayList<>();
    public AutoRickshawCompaniesAdapter(ArrayList<VehicleServices> itemArray, Context mContext) {
        super();
    ...
    public View getView(final int position, View convertView,
        ...
        AutoRickshawCompaniesAdapter.ViewHolder view = null;
        LayoutInflater inflator = ((Activity) mContext).getLayoutInflater();
        if (view == null) {
            view = new AutoRickshawCompaniesAdapter.ViewHolder();
            ...
            view = (AutoRickshawCompaniesAdapter.ViewHolder) convertView.getTag();
        }
