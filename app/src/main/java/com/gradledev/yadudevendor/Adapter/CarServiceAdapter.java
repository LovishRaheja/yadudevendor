...
public class CarServiceAdapter extends BaseAdapter {
    ...
    public CarServiceAdapter(ArrayList<VehicleServices> itemArray, Context mContext) {
        super();
    ...
    public View getView(final int position, View convertView,
        ...
        CarServiceAdapter.ViewHolder view = null;
        LayoutInflater inflator = ((Activity) mContext).getLayoutInflater();
        if (view == null) {
            view = new CarServiceAdapter.ViewHolder();
            ...
            view = (CarServiceAdapter.ViewHolder) convertView.getTag();
        }
