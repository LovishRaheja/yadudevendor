...
public class RSAServcieAdapter extends BaseAdapter {
    private Context mContext;
    ArrayList<VehicleServices> mylist=new ArrayList<>();
    public RSAServcieAdapter(ArrayList<VehicleServices> itemArray, Context mContext) {
        super();
    ...
    public View getView(final int position, View convertView,
        ...
        RSAServcieAdapter.ViewHolder view = null;
        LayoutInflater inflator = ((Activity) mContext).getLayoutInflater();
        if (view == null) {
            view = new RSAServcieAdapter.ViewHolder();
            ...
            view = (RSAServcieAdapter.ViewHolder) convertView.getTag();
        }
