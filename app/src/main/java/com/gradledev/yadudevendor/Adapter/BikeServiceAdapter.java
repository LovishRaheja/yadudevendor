...
public class BikeServiceAdapter extends BaseAdapter {
    private Context mContext;
    ArrayList<VehicleServices> mylist=new ArrayList<>();
    public BikeServiceAdapter(ArrayList<VehicleServices> itemArray, Context mContext) {
        super();
    ...
    public View getView(final int position, View convertView,
        ...
        BikeServiceAdapter.ViewHolder view = null;
        LayoutInflater inflator = ((Activity) mContext).getLayoutInflater();
        if (view == null) {
            view = new BikeServiceAdapter.ViewHolder();
            ...
            view = (BikeServiceAdapter.ViewHolder) convertView.getTag();
        }
