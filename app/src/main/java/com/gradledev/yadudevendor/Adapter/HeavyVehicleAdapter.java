...
public class HeavyVehicleAdapter extends BaseAdapter {
    private Context mContext;
    ArrayList<VehicleServices> mylist=new ArrayList<>();
    public HeavyVehicleAdapter(ArrayList<VehicleServices> itemArray, Context mContext) {
        super();
    ...
    public View getView(final int position, View convertView,
        ...
        HeavyVehicleAdapter.ViewHolder view = null;
        LayoutInflater inflator = ((Activity) mContext).getLayoutInflater();
        if (view == null) {
            view = new HeavyVehicleAdapter.ViewHolder();
            ...
            view = (HeavyVehicleAdapter.ViewHolder) convertView.getTag();
        }
