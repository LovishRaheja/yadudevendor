...
public class MembershipAdapter extends BaseAdapter {
    ...
    public MembershipAdapter(ArrayList<VehicleServices> itemArray, Context mContext) {
        super();
    ...
    public View getView(final int position, View convertView,
        ...
        MembershipAdapter.ViewHolder view = null;
        LayoutInflater inflator = ((Activity) mContext).getLayoutInflater();
        if (view == null) {
            view = new MembershipAdapter.ViewHolder();
            ...
            view = (MembershipAdapter.ViewHolder) convertView.getTag();
        }
