...
public class BikeCompanyAdapter extends BaseAdapter {
    private Context mContext;
    ArrayList<VehicleServices> mylist=new ArrayList<>();
    public BikeCompanyAdapter(ArrayList<VehicleServices> itemArray, Context mContext) {
        super();
    ...
    public View getView(final int position, View convertView,
        ...
        BikeCompanyAdapter.ViewHolder view = null;
        LayoutInflater inflator = ((Activity) mContext).getLayoutInflater();
        if (view == null) {
            view = new BikeCompanyAdapter.ViewHolder();
            ...
            view = (BikeCompanyAdapter.ViewHolder) convertView.getTag();
        }
