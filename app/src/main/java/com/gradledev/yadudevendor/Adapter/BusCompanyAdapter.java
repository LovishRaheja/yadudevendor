...
public class BusCompanyAdapter extends BaseAdapter {
    private Context mContext;
    ArrayList<VehicleServices> mylist=new ArrayList<>();
    public BusCompanyAdapter(ArrayList<VehicleServices> itemArray, Context mContext) {
        super();
    ...
    public View getView(final int position, View convertView,
        ...
        BusCompanyAdapter.ViewHolder view = null;
        LayoutInflater inflator = ((Activity) mContext).getLayoutInflater();
        if (view == null) {
            view = new BusCompanyAdapter.ViewHolder();
            ...
            view = (BusCompanyAdapter.ViewHolder) convertView.getTag();
        }
