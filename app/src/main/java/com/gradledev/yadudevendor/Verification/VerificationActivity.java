package com.gradledev.yadudevendor.Verification;
...
public class VerificationActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.setMessage("Saving verification information");
    ...
    void initiateVerification(boolean skipPermissionCheck) {
        ...
        if (intent != null) {
            String phoneNumber = intent.getStringExtra(VerifyNumber.INTENT_PHONENUMBER);
            String countryCode = intent.getStringExtra(VerifyNumber.INTENT_COUNTRY_CODE);
    ...
    void showCompleted() {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                final Intent mainIntent = new Intent(VerificationActivity.this, MainActivity.class);
